...
export namespace Prisma {
  ...
  */
      ...
      PrintingJob: {
        ...
        operations: {
          ...
          count: {
            ...
            result:
              | $Utils.Optional<PrintingJobCountAggregateOutputType>
              | number;
          };
        };
      };
  ...
  export type PrintingJobAggregateArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     ...
     */
    orderBy?:
      | PrintingJobOrderByWithRelationInput
      | PrintingJobOrderByWithRelationInput[];
    /**
  ...
  export type PrintingJobGroupByArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    where?: PrintingJobWhereInput;
    orderBy?:
      | PrintingJobOrderByWithAggregationInput
      | PrintingJobOrderByWithAggregationInput[];
  ...
  type GetPrintingJobGroupByPayload<T extends PrintingJobGroupByArgs> =
    Prisma.PrismaPromise<
      Array<
        PickEnumerable<PrintingJobGroupByOutputType, T['by']> & {
          [P in keyof T &
            keyof PrintingJobGroupByOutputType]: P extends '_count'
            ? T[P] extends boolean
              ? number
  ...
  export type $PrintingJobPayload<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    name: 'PrintingJob';
    objects: {};
  ...
  type PrintingJobGetPayload<
    S extends boolean | null | undefined | PrintingJobDefaultArgs,
  > = $Result.GetResult<Prisma.$PrintingJobPayload, S>;

  type PrintingJobCountArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = Omit<
    PrintingJobFindManyArgs,
    'select' | 'include' | 'distinct' | 'omit'
  > & {
    select?: PrintingJobCountAggregateInputType | true;
  };

  export interface PrintingJobDelegate<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
    GlobalOmitOptions = {},
  > {
    [K: symbol]: {
      types: Prisma.TypeMap<ExtArgs>['model']['PrintingJob'];
      meta: { name: 'PrintingJob' };
    };
    /**
     ...
     * })
     */
    findUnique<T extends PrintingJobFindUniqueArgs>(
      args: SelectSubset<T, PrintingJobFindUniqueArgs<ExtArgs>>,
    ): Prisma__PrintingJobClient<
      $Result.GetResult<
        Prisma.$PrintingJobPayload<ExtArgs>,
        T,
        'findUnique',
        GlobalOmitOptions
      > | null,
     ...
     * })
     */
    findUniqueOrThrow<T extends PrintingJobFindUniqueOrThrowArgs>(
      args: SelectSubset<T, PrintingJobFindUniqueOrThrowArgs<ExtArgs>>,
    ): Prisma__PrintingJobClient<
      $Result.GetResult<
        Prisma.$PrintingJobPayload<ExtArgs>,
        T,
     ...
     * })
     */
    findFirst<T extends PrintingJobFindFirstArgs>(
      args?: SelectSubset<T, PrintingJobFindFirstArgs<ExtArgs>>,
    ): Prisma__PrintingJobClient<
      $Result.GetResult<
        Prisma.$PrintingJobPayload<ExtArgs>,
        T,
     ...
     * })
     */
    findFirstOrThrow<T extends PrintingJobFindFirstOrThrowArgs>(
      args?: SelectSubset<T, PrintingJobFindFirstOrThrowArgs<ExtArgs>>,
    ): Prisma__PrintingJobClient<
      $Result.GetResult<
        Prisma.$PrintingJobPayload<ExtArgs>,
        T,
     ...
     *
     */
    findMany<T extends PrintingJobFindManyArgs>(
      args?: SelectSubset<T, PrintingJobFindManyArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      $Result.GetResult<
        Prisma.$PrintingJobPayload<ExtArgs>,
        T,
     ...
     *
     */
    create<T extends PrintingJobCreateArgs>(
      args: SelectSubset<T, PrintingJobCreateArgs<ExtArgs>>,
    ): Prisma__PrintingJobClient<
      $Result.GetResult<
        Prisma.$PrintingJobPayload<ExtArgs>,
        T,
     ...
     *
     */
    createMany<T extends PrintingJobCreateManyArgs>(
      args?: SelectSubset<T, PrintingJobCreateManyArgs<ExtArgs>>,
     ...
     *
     */
    delete<T extends PrintingJobDeleteArgs>(
      args: SelectSubset<T, PrintingJobDeleteArgs<ExtArgs>>,
    ): Prisma__PrintingJobClient<
      $Result.GetResult<
        Prisma.$PrintingJobPayload<ExtArgs>,
        T,
     ...
     *
     */
    update<T extends PrintingJobUpdateArgs>(
      args: SelectSubset<T, PrintingJobUpdateArgs<ExtArgs>>,
    ): Prisma__PrintingJobClient<
      $Result.GetResult<
        Prisma.$PrintingJobPayload<ExtArgs>,
        T,
     ...
     *
     */
    deleteMany<T extends PrintingJobDeleteManyArgs>(
      args?: SelectSubset<T, PrintingJobDeleteManyArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<BatchPayload>;
     ...
     *
     */
    updateMany<T extends PrintingJobUpdateManyArgs>(
      args: SelectSubset<T, PrintingJobUpdateManyArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<BatchPayload>;
     ...
     * })
     */
    upsert<T extends PrintingJobUpsertArgs>(
      args: SelectSubset<T, PrintingJobUpsertArgs<ExtArgs>>,
    ): Prisma__PrintingJobClient<
      $Result.GetResult<
        Prisma.$PrintingJobPayload<ExtArgs>,
        T,
     ...
     * })
     **/
    aggregate<T extends PrintingJobAggregateArgs>(
      args: Subset<T, PrintingJobAggregateArgs>,
    ): Prisma.PrismaPromise<GetPrintingJobAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, PrintingJobGroupByArgs, OrderByArg> &
        InputErrors,
    ): {} extends InputErrors
      ? GetPrintingJobGroupByPayload<T>
   ...
   */
  export interface Prisma__PrintingJobClient<
    T,
    Null = never,
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
    GlobalOmitOptions = {},
   ...
   */
  export type PrintingJobFindUniqueArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
   ...
   */
  export type PrintingJobFindUniqueOrThrowArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the PrintingJob
   ...
   */
  export type PrintingJobFindFirstArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the PrintingJob
   ...
   */
  export type PrintingJobFindFirstOrThrowArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the PrintingJob
   ...
   */
  export type PrintingJobFindManyArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the PrintingJob
   ...
   * PrintingJob create
   */
  export type PrintingJobCreateArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the PrintingJob
   ...
   */
  export type PrintingJobCreateManyArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
   ...
   * PrintingJob update
   */
  export type PrintingJobUpdateArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the PrintingJob
   ...
   */
  export type PrintingJobUpdateManyArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     ...
     */
    data: XOR<
      PrintingJobUpdateManyMutationInput,
      PrintingJobUncheckedUpdateManyInput
    >;
    /**
   ...
   * PrintingJob upsert
   */
  export type PrintingJobUpsertArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the PrintingJob
   ...
   * PrintingJob delete
   */
  export type PrintingJobDeleteArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the PrintingJob
   ...
   */
  export type PrintingJobDeleteManyArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
   ...
   */
  export type PrintingJobDefaultArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the PrintingJob
  ...
  > = {
    where?: PricingWhereInput;
    orderBy?:
      | PricingOrderByWithAggregationInput
      | PricingOrderByWithAggregationInput[];
  ...
  type PricingGetPayload<
    S extends boolean | null | undefined | PricingDefaultArgs,
  > = $Result.GetResult<Prisma.$PricingPayload, S>;

  type PricingCountArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  ...
  > {
    ...
    aggregate<T extends PricingAggregateArgs>(
      args: Subset<T, PricingAggregateArgs>,
    ...
    >(
      args: SubsetIntersection<T, PricingGroupByArgs, OrderByArg> & InputErrors,
    ): {} extends InputErrors
  ...
  export type PrintingJobScalarFieldEnum =
    (typeof PrintingJobScalarFieldEnum)[keyof typeof PrintingJobScalarFieldEnum];
  ...
  export type PrintingJobOrderByRelevanceFieldEnum =
    (typeof PrintingJobOrderByRelevanceFieldEnum)[keyof typeof PrintingJobOrderByRelevanceFieldEnum];

  export const PricingOrderByRelevanceFieldEnum: {
    paperType: 'paperType';
  };

  export type PricingOrderByRelevanceFieldEnum =
    (typeof PricingOrderByRelevanceFieldEnum)[keyof typeof PricingOrderByRelevanceFieldEnum];
  ...
  export type PrintingJobScalarWhereWithAggregatesInput = {
    AND?:
      | PrintingJobScalarWhereWithAggregatesInput
      | PrintingJobScalarWhereWithAggregatesInput[];
  ...
  export type PricingScalarWhereWithAggregatesInput = {
    AND?:
      | PricingScalarWhereWithAggregatesInput
      | PricingScalarWhereWithAggregatesInput[];
  ...
  export type PrintingJobOrderByRelevanceInput = {
    fields:
      | PrintingJobOrderByRelevanceFieldEnum
      | PrintingJobOrderByRelevanceFieldEnum[];
    sort: SortOrder;
    search: string;
  };
  ...
  export type PricingOrderByRelevanceInput = {
    fields:
      | PricingOrderByRelevanceFieldEnum
      | PricingOrderByRelevanceFieldEnum[];
    sort: SortOrder;
    search: string;
  };
